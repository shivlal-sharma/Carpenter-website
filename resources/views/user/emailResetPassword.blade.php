...
<body>
    <div class="container" style="font-family: Arial, sans-serif; padding: 20px; background-color: #f8f8f8; border-radius: 8px;">
        ...
        <a href="{{ $url }}" style="display:inline-block; color: #fff; background-color: #4CAF50; padding: 7px 20px; text-decoration: none; border-radius: 5px;">Reset Password</a>
        <p style="color:#f00;">This link is valid for 5 minutes.</p>
